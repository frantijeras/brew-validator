...
2. **`viewBox` CUADRADO 1:1 OBLIGATORIO** — cada SVG declara un `viewBox` con proporción de aspecto cuadrada **1:1** (p. ej. `viewBox="0 0 200 200"`), de modo que todos los logos e imagotipos se compongan dentro de un lienzo cuadrado. Centra el logotipo dentro de ese lienzo cuadrado. No fijes width/height absolutos que rompan la escalabilidad ni uses viewBox rectangulares (como `0 0 200 80`).
