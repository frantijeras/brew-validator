# project-skills — Backup

> Mejora con IA de una skill del Hand-off (Fase 2). Genera el documento markdown
> a medida de UNA skill usando el contexto real del proyecto.

> **BACKUP — fuente de deploy.** Se despliega al VPS con
> `scripts/deploy_skills_vps.py` a `/root/.openclaw/workspace/skills/project-skills/SKILL.md`.
> Ultima sincronizacion: 2026-06-13
